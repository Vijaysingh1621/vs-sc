...
exports.VulnerabilityWebviewProvider = void 0;
        ...
        webviewView.webview.onDidReceiveMessage(data => {
            switch (data.type) {
                case 'fixVulnerability':
                    ...
                    break;
                case 'openFile':
                    vscode.commands.executeCommand('vscode.open', vscode.Uri.file(data.file), { selection: new vscode.Range(data.line - 1, data.column, data.line - 1, data.column + data.length) });
                    break;
            }
        });
    }
...
exports.VulnerabilityWebviewProvider = VulnerabilityWebviewProvider;
VulnerabilityWebviewProvider.viewType = 'vulnerabilityReport';
